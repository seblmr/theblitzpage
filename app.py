...
HOT_IDEAS = [
    ...
    {"name": "The BlitzPage",               "tagline": "Landing pages in 30 seconds from your phone",         "description": "The tool you're using right now. Type 2 sentences → get full HTML + Stripe + X thread.",                                                       "features": "24h to first $,Zero laptop,International ready"},
